...
public class FourBallRight {
    ...
    public FourBallRight (DriveSubsystem _drive, ShooterSubsystem _shooter, ConveyorSubsystem _convey, IntakeSubsystem _intake) {
        drive = _drive;
        shooter = _shooter;
        convey = _convey;
        intake = _intake;
    ...
    TrajectoryConfig config =
        ...
        Trajectory drive4 = TrajectoryGenerator.generateTrajectory(
            new Pose2d(Units.inchesToMeters(4), Units.inchesToMeters(-84), new Rotation2d(Units.degreesToRadians(-90))),
            List.of(),
            new Pose2d(Units.inchesToMeters(30), Units.inchesToMeters(-234), new Rotation2d(Units.degreesToRadians(-45))),
            config4
        );
        ...
        Trajectory drive5 = TrajectoryGenerator.generateTrajectory(
            new Pose2d(Units.inchesToMeters(30), Units.inchesToMeters(-234), new Rotation2d(Units.degreesToRadians(-45))),
            List.of(),
            new Pose2d(Units.inchesToMeters(30 - 84), Units.inchesToMeters(-234 + 84), new Rotation2d(Units.degreesToRadians(-45))),
            config5
        );
        ...
        return   new SequentialCommandGroup(
            ...
            new RamseteCommand(
                ...
                new AutoTurnTurret(shooter, 61.7),
                new SpinUp(shooter, 2410, 17.5)
            ),
            new ParallelDeadlineGroup(
                new WaitCommand(3),
                new AutoShoot(shooter, convey)
